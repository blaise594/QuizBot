...
var connector = new builder.ChatConnector({
    appId: "e796b895-4fae-421a-8198-5580df89c955",
    appPassword: "bqgPXLemaybngAyPOrLM4oM"
});
...
bot.dialog('/',
    ...
    function (session) {
        session.send("Hello! Welcome to the My Quiz Bot. Would you like to study today?")
